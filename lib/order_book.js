var Tree = require('../deps/RedBlackTree');
...
OrderBook.prototype.state = function() {
    ...
    for(; e = this._bid.previous(); ) {
        e.arr.forEach(function(o) {
            bids.push(o.state());
        });
    }

    for(; e = this._ask.next(); ) {
        e.arr.forEach(function(o) {
            asks.push(o.state());
        });
    }
...
OrderList.prototype.compare = function(other) {
    return this.price - other.price;
}

function Price(price) {
    this.price = price,
    this.compare = OrderList.prototype.compare
}
